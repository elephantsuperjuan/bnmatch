   ...
   ResetAction()
   {
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       // System.err.println(networkId);
        ...
        {
  //          System.err.println(Cytoscape.getNetwork(str));
  //          System.err.println(Cytoscape.getNetwork(str).getIdentifier());
  //          System.err.println(Cytoscape.getNetwork(String.valueOf(networkId-1)));
  //          System.err.println(Cytoscape.getNetwork(String.valueOf(networkId-1)).getIdentifier());         
  //          System.err.println(Cytoscape.getDesktop().getNetworkPanel().getNetworkNode(Cytoscape.getNetwork(str).getIdentifier()));
  //          System.err.println(Cytoscape.getDesktop().getNetworkPanel().getNetworkNode(Cytoscape.getNetwork(String.valueOf(networkId-1)).getIdentifier()));
